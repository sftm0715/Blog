...
import me.jeongdahee.springbootdeveloper.config.jwt.JwtFactory;
import me.jeongdahee.springbootdeveloper.config.jwt.JwtProperties;
...
class TokenApiControllerTest {
    ...
    public void createNewAccessToken() throws Exception {
        ...
        // given : 테스트 유저 생성, jjwt 라이브러리를 통해 토큰 만들어 DB 저장
        ...
        // then : 응답코드가 201 Created 인지 확인, 응답으로 온 액세스토큰이 비어있지 않은지 확인.
        resultActions
